...
public class ControllerLegitymacji implements Initializable {
    Connection c = null;
    Statement stmt = null;

    @FXML
    private TableView<ModelTabeli_IDImieNazwisko> tabelaListyLegitymacji;
    @FXML
    ...
    ObservableList<ModelTabeli_IDImieNazwisko> listaDoLegitymacji = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM Student WHERE czyLegitymacjaPodbita = 0");

            while(rs.next()) {
                listaDoLegitymacji.add(new ModelTabeli_IDImieNazwisko(rs.getInt("id_studenta"), rs.getString("imie"), rs.getString("nazwisko")));
        ...
        tabelaListyLegitymacji.setItems(listaDoLegitymacji);
    }
